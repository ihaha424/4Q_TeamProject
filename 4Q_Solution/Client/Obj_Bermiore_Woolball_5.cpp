...
Obj_Bermiore_Woolball_5::Obj_Bermiore_Woolball_5(const std::filesystem::path& meshPath, const std::filesystem::path& physicsPath) :
...
void Obj_Bermiore_Woolball_5::PostInitialize(const Engine::Modules& modules)
{
