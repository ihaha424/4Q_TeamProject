#include "pch.h"
#include "Trigger_Sudium_SoundTrigger_2.h"
#include "Application.h"


Trigger_Sudium_SoundTrigger_2::Trigger_Sudium_SoundTrigger_2(const std::filesystem::path& meshPath, const std::filesystem::path& physicsPath)
	: TriggerArea(meshPath, meshPath)
{
}

void Trigger_Sudium_SoundTrigger_2::Prepare(Engine::Content::Factory::Component* componentFactory)
{
...
void Trigger_Sudium_SoundTrigger_2::DisposeComponents()
{
...
void Trigger_Sudium_SoundTrigger_2::TriggerEvent(const PlayMsg::TriggerObject* msg)
{
...
void Trigger_Sudium_SoundTrigger_2::PreInitialize(const Engine::Modules& modules)
{
	TriggerArea::PreInitialize(modules);
	_sync->SetSerialNumber(8012);
	_sync->AddCallback((short)PacketID::TriggerObject, &Trigger_Sudium_SoundTrigger_2::TriggerEvent, this);
...
void Trigger_Sudium_SoundTrigger_2::PostInitialize(const Engine::Modules& modules)
{
}
