#include "pch.h"
#include "Trigger_Sudium_SoundTrigger_4.h"
#include "Application.h"


Trigger_Sudium_SoundTrigger_4::Trigger_Sudium_SoundTrigger_4(const std::filesystem::path& meshPath, const std::filesystem::path& physicsPath)
	: TriggerArea(meshPath, meshPath)
{
}

void Trigger_Sudium_SoundTrigger_4::Prepare(Engine::Content::Factory::Component* componentFactory)
{
...
void Trigger_Sudium_SoundTrigger_4::DisposeComponents()
{
...
void Trigger_Sudium_SoundTrigger_4::TriggerEvent(const PlayMsg::TriggerObject* msg)
{
...
void Trigger_Sudium_SoundTrigger_4::PostInitialize(const Engine::Modules& modules)
{
}
