#include "pch.h"
#include "Trigger_Sudium_SoundTrigger_5.h"
#include "Application.h"


Trigger_Sudium_SoundTrigger_5::Trigger_Sudium_SoundTrigger_5(const std::filesystem::path& meshPath, const std::filesystem::path& physicsPath)
	: TriggerArea(meshPath, meshPath)
{
}

void Trigger_Sudium_SoundTrigger_5::Prepare(Engine::Content::Factory::Component* componentFactory)
{
...
void Trigger_Sudium_SoundTrigger_5::DisposeComponents()
{
...
void Trigger_Sudium_SoundTrigger_5::TriggerEvent(const PlayMsg::TriggerObject* msg)
{
...
void Trigger_Sudium_SoundTrigger_5::PreInitialize(const Engine::Modules& modules)
{
	TriggerArea::PreInitialize(modules);
	_sync->SetSerialNumber(8015);
	_sync->AddCallback((short)PacketID::TriggerObject, &Trigger_Sudium_SoundTrigger_5::TriggerEvent, this);
...
void Trigger_Sudium_SoundTrigger_5::PostInitialize(const Engine::Modules& modules)
{
}
