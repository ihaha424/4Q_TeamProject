...
namespace PhysicsEngineAPI
{
	...
	public:
		...
		virtual 	Utils::Math::Vector3 GetVelocity() const			= 0;

		virtual void	SetLinearVelocity(const Utils::Math::Vector3& velocity) = 0;
		virtual 	Utils::Math::Vector3 GetLinearVelocity() const			= 0;
		...
		virtual 	Utils::Math::Vector3 GetAngularVelocity() const					= 0;
