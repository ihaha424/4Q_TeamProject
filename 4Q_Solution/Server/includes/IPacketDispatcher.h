...
public:
	...
	virtual void SaveSendPacket(std::string& data, SessionID sid, short packetId, long dataSize) = 0;
	...
	virtual void SaveBroadCastPacket(std::string& data, short packetId, long dataSize) = 0;

	virtual void SessionCreated(SessionID sid) = 0;

	virtual void MakePacket(Packet& packet, std::string& data, SessionID sid, short packetId, long dataSize) = 0;
protected:
