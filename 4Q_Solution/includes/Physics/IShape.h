...
namespace PhysicsEngineAPI
{
	...
	public:
		...
		virtual  Utils::Math::Vector3 GetLocalTranslate()const				= 0;

		virtual void SetLocalRotation(const Utils::Math::Vector4& LocalRotation)	= 0; 
		virtual  Utils::Math::Vector4 GetLocalRotation() const				= 0;

		virtual void SetLocalTransform(const Utils::Math::Transform& LocalTransform)	= 0; 
		virtual  Utils::Math::Transform GetLocalTransform() const					= 0;
